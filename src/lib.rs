/*!
The game struct defines a game of Order and Chaos. A user facing client application should utilize
the public enums and structs described below. A game is considered to be an immutable
